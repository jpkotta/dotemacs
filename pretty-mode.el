...
(defun pretty-patterns-generate ()
...
(defvar pretty-patterns (pretty-patterns-generate)
    "*List of pretty patterns.
Should be a list of the form ((MODE ((REGEXP . GLYPH) ...)) ...)")

(defun pretty-update-patterns ()
  "Update `pretty-patterns' with the output of `pretty-patterns-generate'."
  (interactive)
  (setq pretty-patterns (pretty-patterns-generate)))
